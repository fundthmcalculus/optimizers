...
# Position Wrappers
# ----------------------------------------------------------------------
def calc_critical_positions(
    y: np.ndarray, rho: np.ndarray, r_s: np.ndarray
...
def calc_capture_point_position(
    y: np.ndarray, rho: np.ndarray, r_t: np.ndarray
) -> np.ndarray:
...
def calc_end_effector_position(
    y: np.ndarray, rho: np.ndarray, r_s: np.ndarray
) -> np.ndarray:
...
def calc_obstacle_point_positions(
    y: np.ndarray, rho: np.ndarray, r_t: np.ndarray
) -> tuple[np.ndarray]:
...
def calc_capture_point_velocity(
    y: np.ndarray, rho: np.ndarray, r_t: np.ndarray
) -> np.ndarray:
...
def calc_end_effector_velocity(
    y: np.ndarray, rho: np.ndarray, r_s: np.ndarray
) -> np.ndarray:
...
def calc_obstacle_point_velocities(
    y: np.ndarray, rho: np.ndarray, r_t: np.ndarray
) -> tuple[np.ndarray]:
...
# ----------------------------------------------------------------------
def calc_capture_point_acceleration(
    y: np.ndarray, ddth_t: float, rho: np.ndarray, r_t: np.ndarray
) -> np.ndarray:
...
# Jacobian Wrappers
# ----------------------------------------------------------------------
def calc_J(y: np.ndarray, rho: np.ndarray, r_s: np.ndarray) -> np.ndarray:
...
def calc_J_dot(y: np.ndarray, rho: np.ndarray, r_s: np.ndarray) -> np.ndarray:
