...
with ThreadPoolExecutor() as executor:
    ...
    futures = {executor.submit(optimize_cluster, cluster_idx, cluster_cities): cluster_idx
...
print(f"\n=== Improvements ===")
print(f"VAT vs Scrambled: {((scramble_distance - vat_distance) / scramble_distance * 100):.2f}% improvement")
